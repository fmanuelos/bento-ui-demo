...
export function SkipLink({
  ...
  return (
    <a
      ...
      className={`fixed start-space-3 top-space-3 z-50 -translate-y-24 rounded-shape-md bg-action-primary-background-default px-space-3 py-space-2 text-label-md font-semibold text-action-primary-foreground no-underline transition-transform outline-none focus:translate-y-0 focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-focus-ring focus-visible:outline-solid motion-reduce:transition-none ${className}`}
      {...props}
    >
      {children}
    </a>
