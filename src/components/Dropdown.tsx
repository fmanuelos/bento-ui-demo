        ...
        >
          {items.map((item, index) => (
            <button
              ...
              className={`flex min-h-control-height-md w-full items-center gap-md rounded-md px-md py-sm text-left text-body-sm outline-none hover:bg-action-tertiary-background-hover focus-visible:bg-action-tertiary-background-hover focus-visible:outline-3 focus-visible:outline-focus-ring disabled:cursor-not-allowed disabled:text-text-disabled ${item.destructive ? 'text-text-danger' : ''}`}
            >
