  ...
  function OverlaySurface(
    ...
    return createPortal(
      <div
        ...
        className={`z-40 overflow-y-auto rounded-shape-md border p-scale-2 shadow-lg ${surface === 'inverse' ? 'border-border-inverse bg-surface-inverse text-text-inverse' : 'border-border-secondary bg-surface-raised text-text-primary'} ${className}`}
