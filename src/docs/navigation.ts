...
export const foundationNavigation: readonly DocsNavigationItem[] = foundationDocs.map((foundation) => ({
...
export const componentNavigation: readonly DocsNavigationItem[] = componentDocs.map((component) => ({
...
export const docsNavigation: readonly DocsNavigationSection[] = [
  { title: 'Start', items: [{ title: 'Overview', path: '/docs', description: 'Design-system principles and where to begin.' }] },
  { title: 'Foundations', items: foundationNavigation },
  { title: 'Components', items: [{ title: 'Component index', path: '/docs/components', description: 'Browse the complete component library.' }, ...componentNavigation] },
]
