...
export const componentDocs = [
  ...
  createDoc({
    ...
    related: ['textarea', 'select', 'combobox'],
  }),
  createDoc({
    slug: 'textarea',
    title: 'Textarea',
  ...
  createDoc({
    ...
    related: ['radio-group', 'combobox', 'listbox'],
  }),
  createDoc({
    slug: 'listbox',
    title: 'Listbox',
    ...
    related: ['select', 'combobox', 'dropdown'],
  }),
  createDoc({
    slug: 'combobox',
    title: 'Combobox',
  ...
  createDoc({
    ...
    related: ['checkbox', 'alert'],
  }),
  createDoc({
    slug: 'modal',
    title: 'Modal',
    summary:
      'Creates a short focused surface that blocks background interaction and restores context on close.',
    useCases: ['Short confirmations and focused forms that return to the invoking task.'],
    ...
    accessibility: [
      'Uses the native modal dialog behavior for focus containment and background inertness.',
  ...
  createDoc({
    ...
    related: ['data-grid', 'status-badge'],
  }),
  createDoc({
    slug: 'data-grid',
    title: 'Data grid',
  ...
  createDoc({
    ...
    related: ['button', 'listbox', 'combobox'],
  }),
  createDoc({
    slug: 'navigation',
